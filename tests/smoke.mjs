...
['styles.css?v=supplement1-v2','app.js?v=supplement1-v2'].forEach((x) => must(html,x,x));
...
['@media(max-width:900px)','phase-card','agenda-item','task-check','ledger-table','--font-ui','font-variant-numeric:tabular-nums','contain:layout paint','overflow-wrap:anywhere'].forEach((x) => must(css,x,x));
['renderTimetable','datedBlocks','buildDayAgenda','rangeStarts','2026-09-02','strictDateSchedules','breakfastMenu','breakfastFor','probabilityRawDurations','probabilityModules','lineAlgebraVerifiedDurations','taskCheck','验收：','方浩第1–2讲','线代第2章','p1–6','章→节→题型','章-节-页','九月闭卷小测6题','月末门禁','小作文审题','routeData','updateClock','scheduleClock','visibilitychange','stopLiveUpdates','06:00','24:00','肉夹馍','绿豆粥','英语二 · 2010年 Text 1','英语单词 · 新20 + 旧40','2027数学三带刷计划表','880第一章 · 基础选择8、12、13','第一章必做38题','选择做/特难题不排','Blackboard作业 · 周五开放项','数一不排','今日事今日毕'].forEach((x) => must(js,x,x));
