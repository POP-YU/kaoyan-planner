...
['renderTimetable','datedBlocks','buildDayAgenda','rangeStarts','2026-08-31','breakfastMenu','breakfastFor','probabilityRawDurations','lineAlgebraVerifiedDurations','方浩第1–2讲','线代第2章','p1–3页内全部卡片','routeData','updateClock','scheduleClock','visibilitychange','stopLiveUpdates','06:00','24:00','肉夹馍','绿豆粥','英语二 · 2015年 Text 1','英语单词 · 新30 + 旧60','880第一章 · 基础选择1–13','目录口径60题','Blackboard作业 · 周五开放项','数一不排'].forEach((x) => must(js,x,x));
