...
| `currentBaselineDate` / `majorBaseline` / `majorFirstDayCompletedUnits` | 436 账面起点与每日新单元数；9/10 实绩只完成第1–3个，后续从第4个接续 |
...
| `prioritizeMemorizationBeforeBrush()` | 9/11 起把436背诵/默写排在前面，课余880放在当天最后；非FHSU课内880仍固定，不参与挪动 |
...
- **436**：9/10最终完成第1–3个，第4个起未完成。用户9/11再次确认早格不重复1–3：06:20直接学第4–6个，13:10接第7–8个，15:25统一验收第4–8个；总新量仍为5个。此后5个/学习日、周日只回收；资料结构见 `majorRecitationMaterial`。
...
- **436 页面底部执行法（2026-09-10）**：按当前“第1–3个已背熟、第4个起顺延、非专业、5个新内容/学习日、周日只回收、课内不背436”定制。背诵与默写必须排在课余880之前；完成证据固定为关书口述与完整手写，按A/B/C登记并在当天、次日、第3天、第7天回访。该区必须位于436目录之后、`</main>`之前；不得把熟读、划线或坐满时间写成完成，也不得承诺上岸。
