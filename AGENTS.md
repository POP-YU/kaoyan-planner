...
- **9/10 实际睡眠覆盖（2026-09-10 18:07 用户实时报告）**：14:20–18:07 为实际睡眠，覆盖原 436 缺口、15:00 课内数学与线代 2.8；这些任务不得算完成。`applyReportedNapOverride()` 只改 9/10 当晚和 9/11 线代回收：今晚 19:10 起先处理今日 880 剩余题单，保留 436 闭卷与英语闭环，00:00 关灯；线代 2.8 放入 9/11 08:20–09:50 空闲格，原 03-01 与周五 19:30 BB 不删除。其余日期继续使用固定 18:05 回家规则。
