...
## 当前锚点快照（2026-09-10，改动前先确认用户有没有新进展）

- **实际第 1 天 = 2026-09-10**，9/2 起的账面整体后移 8 天。
- **436**：9/10最终完成第1–3个，第4个起未完成。用户9/11再次确认早格不重复1–3：06:20直接学第4–6个，12:45接第7–8个，16:35统一验收第4–8个；总新量仍为5个。此后5个/学习日、周日只回收；资料结构见 `majorRecitationMaterial`。
