const APP_VERSION = 'holiday-0925b';
...
const holidaySprintFocus = Object.freeze([
  ...
  {label:'概率月末验收',primary:'概率 · 当前断点续看 + 月末时间戳验收',paired:'概率 · 本月对应错题二测',secondary:'线代 · 当前断点保温'},
  {label:'概率主攻三',primary:'概率 · 最早未清断点优先',paired:'概率 · 对应题当场闭卷验收',secondary:'线代 · 不中断保底'},
  {label:'概率主攻四',primary:'概率 · 从昨日真实时间戳续看',paired:'概率 · 概念与计算分流',secondary:'线代 · 从真实时间戳续看'},
  {label:'概率阶段验收',primary:'概率 · 本阶段最弱模块推进',paired:'概率 · 错题二测',secondary:'线代 · 公式与基础题保温'},
