...
const math880Required = {
  source:'李林880题（数学三）· 2026-09-07 改为按题号顺序推进',
  edition:'用户手头《李林880题》数学三',
  rule:'从第1题按题号顺序推进，14–16题/天（课内刷题格计入）；错题次日回做；全书每道题都做，不再跳题',
  alignment:'章内题数以手头书为准；做到章末即转下一章第1题',
  chapter1:{count:38},
  chapter2:{count:56},
  chapter3:{count:86},
  chapter4:{count:40},
...
const strictDateSchedules = {
  '2026-09-02': strictMorning('2026-09-02','英语单词 · 新20 + 旧40','english','40分钟主动回想',[
    ['08:20','09:55','外贸英文函电课内 · 880第一章 第1–8题','math','必做8题（按题号顺序，从第1题起）；错题次日回做'],
    ...
    ['19:30','21:30','880第一章 · 第9–24题','math','必做16题（按题号顺序）；错题次日回做'],
  ...
  '2026-09-03': strictMorning('2026-09-03','880第一章 · 昨日错题4题','math','闭卷回做，写一句错因',[
    ['08:20','09:55','报关实务课内 · 880第一章 第25–32题','math','必做8题（按题号顺序）；错题次日回做'],
  ...
  '2026-09-04': strictMorning('2026-09-04','英语单词 · 新25 + 旧50','english','75词主动回想',[
    ...
    ['10:10','11:45','外贸英文函电课内 · 880第二章 第1–8题','math','必做8题（按题号顺序）；错题次日回做'],
    ...
    ['18:00','20:30','880第二章 · 第9–24题','math','必做16题（按题号顺序）；错题次日回做'],
  ...
  '2026-09-05': strictMorning('2026-09-05','436 · p1–18闭卷框架','major','先写后看，标3个断点',[
    ...
    ['17:40','18:00','短休 · 准备资料','free','20分钟'],
    ['18:00','20:30','880第二章 · 第25–38题','math','必做14题（按题号顺序）；错题次日回做'],
  ...
  '2026-09-06': strictMorning('2026-09-06','880第一章 · 必做错题4题','math','闭卷回做，选择做/特难题不排',[
    ...
    ['19:30','20:45','880第二章 · 第39–50题','math','必做12题（按题号顺序）；错题次日回做'],
  ...
  '2026-09-07': strictMorning('2026-09-07','英语单词 · 新20 + 旧40','english','60词主动回想',[
    ['08:20','09:55','报关实务课内 · 880第二章 第51–56题 · 第二章收口','math','必做6题（按题号顺序）；收口后错题回做'],
    ['09:55','10:10','下课休息 · 走动补水','free','15分钟'],
    ...
    ['13:15','14:50','财务管理','fhsu',''],
    ['14:50','16:35','880第二章 · 错题回做 + 跳过题补做','math','第二章56题收口后的加餐：错题和课上跳过的题闭卷回做'],
    ['16:35','17:00','通勤 · 学校→家','routine','约20分钟'],
    ['17:00','17:40','晚饭 + 放空','meal','正常吃饭'],
    ['17:40','18:00','短休 · 准备资料','free','20分钟'],
  ...
  '2026-09-08': strictMorning('2026-09-08','436 · p1–30闭卷复述','major','卡住再翻页',[
    ...
    ['17:00','17:40','晚饭 + 放空','meal','正常吃饭'],
    ['17:40','18:00','短休 · 准备资料','free','20分钟'],
    ['18:00','20:00','880第三章 · 第1–14题','math','必做14题（按题号顺序）；错题次日回做'],
  ...
  '2026-09-09': strictMorning('2026-09-09','英语单词 · 新20 + 旧40','english','60词主动回想',[
    ['08:20','09:55','外贸英文函电课内 · 880第三章 第15–22题','math','必做8题（按题号顺序）；错题次日回做'],
    ['09:55','10:10','下课休息 · 走动补水','free','15分钟'],
    ...
    ['19:30','21:30','880第三章 · 第23–36题','math','必做14题（按题号顺序）；错题次日回做'],
  ...
  '2026-09-10': strictMorning('2026-09-10','880第二章 · 已做错题4题','math','闭卷回做，写错因',[
    ['08:20','09:55','报关实务课内 · 880第三章 第37–44题','math','必做8题（按题号顺序）；错题次日回做'],
    ['09:55','10:10','下课休息 · 走动补水','free','15分钟'],
    ['10:10','11:45','商业政策','fhsu',''],
    ['11:45','12:20','午饭','meal','正常吃饭'],
    ['12:20','12:45','午休 · 闭眼25分钟','sleep','定闹钟'],
    ...
    ['15:00','16:35','国际贸易实务课内 · 880第三章 第45–52题','math','必做8题（按题号顺序）；课内静默完成'],
    ['16:35','17:00','通勤 · 学校→家','routine','约20分钟'],
    ['17:00','17:40','晚饭 + 放空','meal','正常吃饭'],
    ['17:40','18:00','短休 · 准备资料','free','20分钟'],
  ...
  '2026-09-11': strictMorning('2026-09-11','英语单词 · 新25 + 旧50','english','75词主动回想',[
    ...
    ['10:00','10:10','休息 · 走动补水','free','10分钟'],
    ['10:10','11:45','外贸英文函电课内 · 880第三章 第53–60题','math','必做8题（按题号顺序）；错题次日回做'],
    ['11:45','12:20','午饭','meal','正常吃饭'],
    ['12:20','12:45','午休 · 闭眼25分钟','sleep','定闹钟'],
  ...
  '2026-09-12': strictMorning('2026-09-12','436 · p1–54闭卷框架','major','先写后看，标断点',[
    ...
    ['17:00','17:40','晚饭 + 放空','meal','正常吃饭'],
    ['17:40','18:00','短休 · 准备资料','free','20分钟'],
    ['18:00','20:30','880第三章 · 第75–86题 · 第三章收口','math','必做12题（按题号顺序）；收口后错题回做'],
  ...
  '2026-09-13': strictMorning('2026-09-13','880第二章 · 必做错题4题','math','闭卷回做，选择做/特难题不排',[
    ...
    ['19:30','20:45','880第四章 · 第1–12题','math','必做12题（按题号顺序）；错题次日回做'],
...
const septemberContinuation = {
  '2026-09-14':{major:'p61–66',mathMorning:['880第四章 · 第13–20题',8],math:['880第四章 · 第21–34题',14,'必做14题（按题号顺序，接上午课内8题之后）；错题次日回做'],english:'英语二 · 2012年 Text 3',prob:'概率 · 方浩第19–20讲 + 基础题6道'},
  '2026-09-15':{major:'p67–72',math:['880第四章 · 第35–40题 · 第四章收口',6,'必做6题（按题号顺序）；收口后错题回做'],english:'英语二 · 2012年 Text 4'},
  '2026-09-16':{major:'p73–78',mathMorning:['880第五章 · 第1–8题',8],math:['880第五章 · 第9–22题',14,'必做14题（按题号顺序，接上午课内8题之后）；错题次日回做'],english:'英语二 · 2013年 Text 1',prob:'概率 · 方浩第21–22讲 + 基础题6道'},
  '2026-09-17':{major:'p79–84',mathMorning:['880第五章 · 第23–30题',8],math:['880第五章 · 第31–41题 · 第五章收口',11,'必做11题（按题号顺序，下午课内格完成）；收口后错题回做'],english:'英语二 · 2013年 Text 2'},
  '2026-09-18':{major:'p85–90',mathMorning:['880第六章 · 第1–8题',8],math:['880第六章 · 第9–22题',14,'必做14题（按题号顺序，接上午课内8题之后）；错题次日回做'],english:'英语二 · 2013年 Text 3',prob:'概率 · 方浩第23–24讲 + 基础题6道'},
  '2026-09-19':{major:'p91–96',math:['880第六章 · 第23–36题',14,'必做14题（按题号顺序）；错题次日回做'],english:'英语二 · 2013年 Text 4',prob:'概率 · 方浩第25–26讲 + 基础题6道'},
  '2026-09-20':{major:'p97–108',math:['880第六章 · 第37题 · 第六章收口',1,'必做1题（收口）；其余时间全书错题回做'],english:'英语 · 2012–2013阅读错因回看 + 小作文审题1篇',prob:'概率 · 方浩第27–28讲 + 基础题6道'},
  '2026-09-21':{major:'p109–114',mathMorning:['880第七章 · 第1–8题',8],math:['880第七章 · 第9–22题',14,'必做14题（按题号顺序，接上午课内8题之后）；章内题数以手头书为准'],english:'英语二 · 2014年 Text 1'},
  '2026-09-22':{major:'p115–120',math:['880第七章 · 第23–36题',14,'必做14题（按题号顺序）；做到章末即转第八章第1题'],english:'英语二 · 2014年 Text 2'},
  '2026-09-23':{major:'p121–126',mathMorning:['880第七章 · 第37–44题',8],math:['880第七章 · 第45–58题',14,'必做14题（按题号顺序，接上午课内8题之后）；做到章末即转第八章第1题'],english:'英语二 · 2014年 Text 3'},
  '2026-09-24':{major:'p127–132',math:['880第七章 · 按题号顺序推进8题（接上午课内）',8,'必做8题（按题号顺序）；做到章末即转第八章第1题'],english:'英语二 · 2014年 Text 4'},
...
const continuationRows = (date,spec) => {
  ...
  if(day===3)return [
    ['08:20','09:55',...(spec.mathMorning?['外贸英文函电课内 · '+spec.mathMorning[0],'math',`必做${spec.mathMorning[1]}题（按题号顺序）；错题次日回做`]:['外贸英文函电课内 · 刷880（按题号顺序续推8题）','math','必做8题；接昨日账面题号继续；错题次日回做'])],['09:55','10:10','下课休息 · 走动补水','free','15分钟'],['10:10','11:45',`436 · ${spec.major} + 短答2题`,'major','新内容学习：先框架再闭卷'],...lunch,['12:45','13:15',...politics(30)],['13:15','14:50','财务管理','fhsu',''],['14:50','15:00','下课休息 · 走动10分钟','free','换教室'],['15:00','16:35','营销学','fhsu',''],...evening,['18:00','18:50',...(prob||['数学 · 上一日错题4题','math','闭卷回做'])],['18:50','21:20',...math],['21:20','22:10',...english],['22:10','23:00','436 · 当日新页闭卷复述','major','卡住再翻'],['23:00','23:20','英语单词 · 今日薄弱词30','english','只回收错词']
  ];
  if(day===4)return [
    ['08:20','09:55',...(spec.mathMorning?['报关实务课内 · '+spec.mathMorning[0],'math',`必做${spec.mathMorning[1]}题（按题号顺序）；错题次日回做`]:['报关实务课内 · 刷880（按题号顺序续推8题）','math','必做8题；接昨日账面题号继续；错题次日回做'])],['09:55','10:10','下课休息 · 走动补水','free','15分钟'],['10:10','11:45','商业政策','fhsu',''],...lunch,['12:45','13:35',...english],['13:35','14:15',...politics(40)],['14:15','15:00',`436 · ${spec.major}新内容学习`,'major','先框架再闭卷'],['15:00','16:35',`国际贸易实务课内 · ${math[0]}`,'math',`${math[2]}；课内静默完成`],...evening,['18:00','19:30','880 · 课内题目收口 + 当日错因','math','未完成题先收口，再逐题复盘'],['19:30','20:30',...(prob||['数学 · 公式与错因回想','math','不看答案先写'])],['20:30','22:00','436 · 当日新页闭卷复述 + 短答2题','major','完整输出'],['22:00','23:20','英语单词 · 新25 + 旧50','english','75词主动回想']
  ];
  if(day===5)return [
    ['08:20','10:00',...(prob||['数学 · 上一章错题6道','math','闭卷回做'])],['10:00','10:10','休息 · 走动补水','free','10分钟'],['10:10','11:45',...(spec.mathMorning?['外贸英文函电课内 · '+spec.mathMorning[0],'math',`必做${spec.mathMorning[1]}题（按题号顺序）；错题次日回做`]:['外贸英文函电课内 · 刷880（按题号顺序续推8题）','math','必做8题；接昨日账面题号继续；错题次日回做'])],...lunch,['12:45','13:45','Blackboard作业 · 只做已开放必交项','homework','完成并确认上传'],['13:45','15:45',`436 · ${spec.major} + 计算1题 + 短答2题`,'major','新内容学习；计算写完整步骤'],['15:45','16:05','通勤 · 学校→家','routine','约20分钟'],['16:05','17:00','休息 · 洗澡/补水','free','明确恢复'],['17:00','17:40','晚饭 + 放空','meal','正常吃饭'],['17:40','18:00','短休 · 准备资料','free','20分钟'],['18:00','20:30',...math],['20:30','21:20',...english],['21:20','22:00',...politics(40)],['22:00','23:00','436 · 当日新页闭卷复述','major','卡住再翻'],['23:00','23:20','英语单词 · 今日薄弱词30','english','只回收错词']
  ];
  if(day===6)return [
...
const courseLedger = [
  {subject:'高数 · 李林880',now:'从第1题按题号顺序推进，14–16题/天（课内刷题格计入）',week:'第一章38题2天收口（9/2–9/3账）；第二章56题4天收口（9/4–9/7账）；第三章86题9/8–9/12账、第四章40题9/13–9/15账、第五章41题9/16–9/17账、第六章37题9/18–9/20账；9/21起第七章按序推进；9/28–9/29错题总回做',done:'当天独立做完并标错因；错题次日回做；课上跳过的题当晚补'},
...
const routeData = [
  {dates:'9月2日—9月13日',title:'高强度起步 · 先把今天做实',desc:'9/2–9/5连续四天没有执行，2026-09-06作为实际第1天，账面任务整体顺延4天消化，不把未完成当完成。880从第一章第1题按题号顺序推进，14–16题/天：第一章必做38题2天收口（9/2–9/3账）、第二章必做56题4天收口（9/4–9/7账）；课内时间一律刷题，436出声背放家里晚间。每天18:05回家：到家先充电+挂下载，晚自习在家三段走。线代第1天先收尾第2章（2.8@34%），概率从第1讲开始，英语一篇一闭环；436快速多轮，每个学习日新增9个内容单元。',check:'验收：数学闭卷+错因；436按资料顺序输出；睡眠守住00:00最晚边界',color:'#5572b8',tint:'#e8eefb'},
  {dates:'9月14日—9月30日',title:'高数强化 · 边学边回测',desc:'880第三—六章按题号顺序推进：9/12账收第三章86题、9/15账收第四章40题、9/17账收第五章41题、9/20账收第六章37题；9/21起第七章继续按序推进；9/28–9/29错题总回做、9/30九月小测。概率第19—28讲收尾。436以9个/天快过，9/30账收完一轮213个并总回收；英语阅读每天闭环，政治保持低量。',check:'验收：每个单元能闭卷说出框架；每道错题有概念/计算/思路标签',color:'#e46c4e',tint:'#fbe6df'},
  {dates:'10月1日—10月31日',title:'线代概率 + 真题入口',desc:'880第七—二十一章继续按题号顺序推进，14–16题/天（课内刷题格计入）；已结束章节按9月正确率决定何时加入分章真题。436进入第二轮滚动输出（9个/天继续），英语阅读继续并加入小三门，政治刷选择题。',check:'9月30日只是测量与校准：现在就执行；月底登记实际数据，按剩余必做题、可用分钟、订正/回测量重排，不等到9月30日；未达项首块先回补。',color:'#3b9b94',tint:'#e1f3f0'},
  {dates:'11月1日—11月30日',title:'套卷与多轮输出',desc:'数学转整套真题与错题回做，880剩余章节按题号顺序收尾；436第三—四轮以名词、短答、计算的限时输出为主；英语小三门和作文进入课表，政治选择题二轮并接时政。',check:'验收：能解释每个失分，而不是只看分数',color:'#d79b46',tint:'#fff0d7'},
  {dates:'12月1日—初试前',title:'模拟与保温',desc:'数学回收错题、近年真题和公式，880按题号顺序把剩余部分收尾；436滚动背诵并做整套模拟，英语整卷与作文默写，政治主观题集中背诵。',check:'验收：按考试时长完成，不靠熬夜硬撑',color:'#8170b5',tint:'#eeebf5'}
];
