...
// 必做 9/8–10/17 完成；选择做 10/18–10/20 集中处理；特难题 10/21 收尾；
...
const math880Required = {
  ...
  rule:'按带刷计划表逐日跳选指定题号：必做828题9/8–10/17完成；选择做37题10/18–10/20集中处理；特难题16题10/21收尾；错题次日回做',
...
const courseLedger = [
  {subject:'高数 · 李林880',now:'带刷表跳选题号（2026-09-07中午拍板）：必做828题9/8–10/17完成；选择做37题10/18–10/20集中处理；特难题16题10/21收尾',week:'逐日题单写在每天课表的“880 带刷”格里，题号与《2027李林880带刷执行计划.xlsx》逐题核对一致；周日轻量+复盘；落后按缓冲顺延（brushPlanLagDays +1）',done:'当天独立做完并标错因；错题次日回做；课上跳过的题当晚补'},
...
const routeData = [
  {dates:'9月2日—9月13日',title:'高强度起步 · 先把今天做实',desc:'9/2–9/5连续四天没有执行，2026-09-06作为实际第1天，账面任务整体顺延4天消化，不把未完成当完成。880改按带刷计划表逐日跳选题号（2026-09-07中午拍板；实际9/8开刷，必做828题9/8–10/17完成，881个题号已与原表逐题核对一致）；课内时间一律刷题，436出声背放家里晚间。每天18:05回家：到家先充电+挂下载，晚自习在家三段走。线代第1天先收尾第2章（2.8@34%），概率从第1讲开始，英语一篇一闭环；436快速多轮，每个学习日新增9个内容单元。',check:'验收：数学闭卷+错因；436按资料顺序输出；睡眠守住00:00最晚边界',color:'#5572b8',tint:'#e8eefb'},
  {dates:'9月14日—9月30日',title:'高数强化 · 边学边回测',desc:'880带刷题单逐日覆盖数学格（第3—14章题号按表推进，周日轻量+复盘）；概率第19—28讲收尾。436以9个/天快过，9/30账收完一轮213个并总回收；英语阅读每天闭环，政治保持低量。',check:'验收：每个单元能闭卷说出框架；每道错题有概念/计算/思路标签',color:'#e46c4e',tint:'#fbe6df'},
  {dates:'10月1日—10月31日',title:'带刷收尾 + 真题入口',desc:'880带刷计划收尾：10/17前完成必做828题，10/18–10/20选择做37题集中处理，10/21特难题16题收尾（逐日题单见课表“880 带刷”格）。436进入二轮滚动输出（9个/天继续），英语阅读错因保温，政治刷选择题。',check:'9月30日只是测量与校准：现在就执行；月底登记实际数据，按剩余题单、可用分钟、订正/回测量重排，不等到9月30日；未达项首块先回补。',color:'#3b9b94',tint:'#e1f3f0'},
