...
const septemberContinuation = {
  ...
  '2026-09-30':{
    ...
    majorGate:[
     ...
     monthGate:'登记880小测正确数/三类错因、436需回补的章-节-内容单元（一轮213个已于9/29账收口）、英语重复错因、近7天23:30前关灯天数；若880低于4/6、436任一章只记标题或计算空白、英语同类错重复2次、关灯少于5/7天，10月首个对应块先回补'
  }
};
...
const courseLedger = [
  ...
  {subject:'436 · 背诵笔记',now:'《背诵笔记》结构已逐页核对：背诵篇10章213个编号知识点（p1–75）+ 计算题篇按章重点题（p76–168）；前三个内容单元已背，第1天账（实际9/6）从第4个继续',week:'快速多轮：每天新增9个内容单元（按账面周一至周六）；周日账只回收；未完次日账只补3个，不挤睡眠；一轮213个于9/29账（实际10/3）收口，9/30账总回收',done:'按手头资料顺序合书复述；短答/计算完整落笔，记录断点章-节-内容单元'},
...
const routeData = [
  ...
  {dates:'9月14日—9月30日',title:'高数强化 · 边学边回测',desc:'880第三—六章同密度推进：9/16账收第三章86题、9/20账收第四章40题、9/24账收第五章41题、9/27账收第六章37题，选择做/特难题不排；9/28选择做加练、9/29错题总回做、9/30九月小测。概率第19—28讲收尾。436以9个/天快过，9/29账收完一轮213个，9/30账总回收；英语阅读每天闭环，政治保持低量。',check:'验收：每个单元能闭卷说出框架；每道错题有概念/计算/思路标签',color:'#e46c4e',tint:'#fbe6df'},
